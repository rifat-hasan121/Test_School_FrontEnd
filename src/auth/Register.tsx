...
const Register: React.FC = () => {
  ...
  const handleRegister = (e: FormEvent<HTMLFormElement>) => {
    ...
    const photo = (form.photo as HTMLInputElement).value;
    ...
    if (!passValidation.test(password)) {
      setError(
        "Password should contain at least 1 capital letter, 1 lowercase letter and be at least 6 characters"
      );
      return;
    }
